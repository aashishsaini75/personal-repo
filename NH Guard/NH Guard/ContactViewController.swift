...
class ContactViewController: UIViewController,WKNavigationDelegate {
    ...
    @IBOutlet var contactbackbutton: UIImageView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let myURL = URL(string:"https://nh.ng.mil/Contact-Us/")
        ...
        let tapGesture4 = UITapGestureRecognizer(target: self, action: #selector(imageTapped4))
                    ...
                    contactbackbutton.addGestureRecognizer(tapGesture4)
                    // make sure imageView can be interacted with by user
                contactbackbutton.isUserInteractionEnabled = true
