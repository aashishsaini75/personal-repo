...
import UIKit
import WebKit
class YellowViewController: UIViewController,WKNavigationDelegate {
    ...
    super.viewDidLoad()
    let myURL = URL(string:"https://nh.ng.mil/Soldier-Services/Yellow-Ribbon-Reintegration-Program/")
