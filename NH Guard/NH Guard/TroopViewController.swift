...
import UIKit
import WebKit
class TroopViewController: UIViewController,WKNavigationDelegate {
    ...
    super.viewDidLoad()
    let myURL = URL(string:"https://nh.ng.mil/Components/Army/54th-Troop-Command/")
