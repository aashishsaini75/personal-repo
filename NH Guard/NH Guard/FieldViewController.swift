...
import UIKit
import WebKit
class FieldViewController: UIViewController,WKNavigationDelegate {
    ...
    super.viewDidLoad()
    let myURL = URL(string:"https://nh.ng.mil/Components/Army/197th-Field-Artillery/")
