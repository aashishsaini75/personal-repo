...
import UIKit
import WebKit
class StateresViewController: UIViewController,WKNavigationDelegate {
    ...
    super.viewDidLoad()
    let myURL = URL(string:"https://nh.ng.mil/Family-Services/State-Resilience-Wellness-Program/")
