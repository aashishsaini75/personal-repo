...
import UIKit
import WebKit
class ChaplainViewController: UIViewController,WKNavigationDelegate {
    ...
    super.viewDidLoad()
    let myURL = URL(string:"https://nh.ng.mil/Family-Services/Chaplain-Services/")
