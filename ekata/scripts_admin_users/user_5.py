...
username = "bot_user_5_"+str(val)
email="bot_user_5@gmail.com"
...
class MyTestCase(unittest.TestCase):
    def test_something(self):
        ...
        driver.find_element_by_name("password1").send_keys("bot_user_5_password")
        driver.find_element_by_name("password2").send_keys("bot_user_5_password")
