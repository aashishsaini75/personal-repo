...
username = "bot_user_2_"+str(val)
email="bot_user_2@gmail.com"
driver.get(url)
driver.find_element_by_name("username").send_keys(username)
driver.find_element_by_name("email").send_keys(email)
driver.find_element_by_name("password1").send_keys("bot_user_2_password")
driver.find_element_by_name("password2").send_keys("bot_user_2_password")
