...
prod_url = "http://bestviewsreviews.com/api/product/inactive_list"
...
for k in asin_list:
    ...
    if "We don't know when or if this item will be back in stock." not in driver.page_source and "Sorry! We couldn't find that page. Try searching or go to Amazon's home page." not in driver.page_source:
        now = datetime.now()
